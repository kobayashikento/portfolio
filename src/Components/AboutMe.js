...
const AboutMe = (props) => {
    ...
    const handleScroll = (e) => {
        if (matches) {
            ...
            if (e.scrollTop > window.innerHeight * 1) {
                setBarsOpen(true);
            } else {
                setBarsOpen(false);
            }
    ...
    return (
        ...
        >
            { matches ?
                    ...
                    <div style={{ display: "flex", height: "fit-content", flexDirection: "column", alignItems: "center", width: '100%' }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "6%", flexDirection: "column", width: "50%" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                <img src={mePic} alt="picture_of_me" style={{ marginLeft: "4%", width: "60%", height: "auto", borderRadius: "3px", transform: "translateX(20%)", boxShadow: "rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" }} />
                            </div>
                            <div style={{ display: "flex", justifyContent: "flex-start", marginTop: "20%", flexDirection: "column", width: "100%" }}>
                                ...
                                >
                                    {show => show && (prop => <div style={{
                                        ...prop, right: "0px", display: "flex", alignItems: "center", overflow: "hidden", marginLeft: "6%",
                ...
                :
                <div style={{ position: "absolute", top: "20vh", background: "linear-gradient(rgb(240,242,244) 20%, #fff 20%)", width: "100vw", display: "flex", justifyContent: 'center', overflow: "hidden" }}>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                        ...
                        <div style={{ display: 'flex', paddingTop: "7%" }}>
                            <div style={{ margin: "1.3rem", display: "flex", flexDirection: "column", alignItems: "center" }}>
                                <Typography style={{ width: "max-content", color: "#072142", fontFamily: "FuturaB", fontSize: "2rem", fontWeight: "bold", letterSpacing: "3px", marginBottom: "6px" }}>
                                    Kento Kobayashi
                </Typography>
                                <Typography style={{ width: "max-content", color: "rgba(0,0,0, 0.4)", fontFamily: "DINNextLTPro-Medium", fontSize: "1.5rem", fontWeight: "400", letterSpacing: "3px", marginBottom: "6px" }}>
                                    Web Developer
                        ...
                        <Grid spacing={5} container style={{ transform: "scale(0.95)", width: "100vw" }} >
                            {trail.map(({ x, height, ...rest }, index) => (
                                <Grid item xs={6} sm={6}>
                                    <animated.div
                                        key={jobValues[index].key}
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "6%", flexDirection: "column", width: "50%" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection: "column" }}>
                                <div style={{ display: "flex", alignItems: "center", width: "100vw", justifyContent: "center" }}>
                                    <div style={{ display: "flex", alignItems: "center", position: "absolute", left: "0" }}>
                                        <Divider style={{ height: "4px", background: "rgba(7, 33, 66, 0.9)", borderRadius: "4px", width: "1.5rem", marginRight: "0.5rem" }} />
                                        <Typography style={{
                                            width: "max-content", color: "#ff4d5a", fontFamily: "'Abril Fatface', cursive", fontSize: "2.5rem", textShadow: "0 10px 30px rgba(2, 11, 22, 0.25)"
                                        }}>
                                            01
                                    ...
                                    <Typography style={{ width: "max-content", color: "#072142", fontFamily: "FuturaM", fontSize: "2.3rem", fontWeight: "bold", letterSpacing: "3px", textShadow: "0 10px 30px rgba(2, 11, 22, 0.25)" }}>
                                        About Me
                </Typography>
                                </div>
                                <Typography style={{
                                    fontSize: "15px", color: "rgba(0,0,0, 0.5)", fontFamily: "FuturaB", fontWeight: "400", padding: "3rem"
                                }}>
                                    Experienced Front-End Web and App Developer with a Bachelors of Science in Mathematics and Statistics from the University of Toronto.
      </Typography>
                                <img src={mePic} alt="picture_of_me" style={{ width: "70%", height: "auto", borderRadius: "3px", boxShadow: "rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" }} />
                            </div>
                            <div style={{ display: "flex", justifyContent: "flex-start", marginTop: "20%", flexDirection: "column", width: "100vw" }}>
                                <div style={{ display: "flex", alignItems: "center", width: "100vw", justifyContent: "center" }}>
                                    <div style={{ display: "flex", alignItems: "center", position: "absolute", left: "0" }}>
                                        <Divider style={{ height: "4px", background: "rgba(7, 33, 66, 0.9)", borderRadius: "4px", width: "1.5rem", marginRight: "0.5rem" }} />
                                        <Typography style={{
                                ...
                                >
                                    {show => show && (prop => <div style={{
                                        ...prop, right: "0px", display: "flex", alignItems: "center", overflow: "hidden", justifyContent: "center"
                                    }}>
                                        <animated.div style={{ ...springBars, zoom: "0.9" }}>
                                            <ExperienceBar
                                                render={barsOpen}
                                                name={"Algorithms"}
                                                percentage={90}
                            ...
                            <div style={{ display: "flex", justifyContent: "flex-start", marginTop: "19%", flexDirection: "column", width: "100vw" }}>
                                <div style={{ display: "flex", alignItems: "center", width: "100vw", justifyContent: "center" }}>
                                    <div style={{ display: "flex", alignItems: "center", position: "absolute", left: "0" }}>
                                        <Divider style={{ height: "4px", background: "rgba(7, 33, 66, 0.9)", borderRadius: "4px", width: "1.5rem", marginRight: "0.5rem" }} />
                                        <Typography style={{
                                    ...
                                    <Typography style={{ marginBottom: "2rem", width: "max-content", color: "#072142", fontFamily: "FuturaM", fontSize: "2.3rem", fontWeight: "bold", letterSpacing: "3px", textShadow: "0 10px 30px rgba(2, 11, 22, 0.25)" }}>
                                        Timeline
                </Typography>
                                </div>
                                <VerticalTimeline>
