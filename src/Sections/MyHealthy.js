...
const content = { 
    ...
    mockAll: mockAll, detailsText: "This website adds functionalities that are not present in the default Shopify theme such as on hover drop-down menu, on-demand search, improved design on the image carousel, and better navigation menu. This website also provides a clean and different design to distinguish the store from the many existing Shopify templates.",
